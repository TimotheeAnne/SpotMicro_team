...
class FFNN(nn.Module):
    ...
    """
    def __init__(self, dim_in, hidden, dim_out, CUDA=False, num_tasks=None, SEED=None, output_limit=None, dropout=0, hidden_activation="tanh"):
...
def train(model, data_in, data_out, inner_iter=100, inner_lr=1e-3, minibatch=32, optimizer=None, task_id=None):
...
if __name__ == '__main__':    
    ...
    '''-----------Meta learning------------'''
    m = FFNN(dim_in=1, hidden=[20,20,20], dim_out=1, CUDA=True, SEED=None, output_limit=None, dropout=0.0)
    train_meta(m, tasks_in, tasks_out, meta_iter=meta_iter, inner_iter=inner_iter, inner_step=n_step, meta_step=m_step, minibatch=32, inner_sample_size=64)    
    m.save("model.pt")
    ...
    '''--------------No meta leaning-----------------------'''
    model2 = FFNN(dim_in=1, hidden=[20,20, 20], dim_out=1, CUDA=False, SEED=None, output_limit=None, dropout=0.0)
